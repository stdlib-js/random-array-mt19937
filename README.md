...
```javascript
import mt19937 from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-array-mt19937@v0.2.2-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/random-array-mt19937/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/random-array-mt19937/actions/workflows/test.yml?query=branch:v0.2.2
