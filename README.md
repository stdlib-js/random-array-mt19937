...
```javascript
import mt19937 from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-array-mt19937@v0.2.2-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { factory } from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-array-mt19937@v0.2.2-esm/index.mjs';
```
